...
public class CreditoRemotoDTO {
    ...
    public int getOrigemAgencia() { return origemAgencia; }
    public void setOrigemAgencia(int origemAgencia) { this.origemAgencia = origemAgencia; }
}